...
) : BasePhase<EnrichAgendaItemsInput, LlmResponse.AgendaTriaged>(webScraper, llmClient) {

    override val name = "Phase 5: Enrich agenda items"

    override suspend fun doExecute(input: EnrichAgendaItemsInput): LlmResponse.AgendaTriaged? {
